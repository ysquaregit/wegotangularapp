/**
 * angular-weather-widget - Weather Widget based on Open Weather Map Api
 * @version v1.2.4
 * @author Krzysztof Saja
 * @link https://github.com/krzysztofsaja/angular-weather-widget#readme
 * @license MIT
 */
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@angular/core"), require("@angular/http"), require("rxjs/add/observable/interval"), require("rxjs/add/operator/merge"), require("rxjs/add/operator/mergeMap"), require("rxjs/add/operator/multicast"), require("rxjs/Observable"), require("rxjs/Subject"), require("rxjs/add/operator/map"), require("rxjs/add/operator/filter"), require("rxjs/add/operator/catch"), require("rxjs/add/operator/first"), require("@angular/common"));
	else if(typeof define === 'function' && define.amd)
		define(["@angular/core", "@angular/http", "rxjs/add/observable/interval", "rxjs/add/operator/merge", "rxjs/add/operator/mergeMap", "rxjs/add/operator/multicast", "rxjs/Observable", "rxjs/Subject", "rxjs/add/operator/map", "rxjs/add/operator/filter", "rxjs/add/operator/catch", "rxjs/add/operator/first", "@angular/common"], factory);
	else if(typeof exports === 'object')
		exports["angularWeatherWidget"] = factory(require("@angular/core"), require("@angular/http"), require("rxjs/add/observable/interval"), require("rxjs/add/operator/merge"), require("rxjs/add/operator/mergeMap"), require("rxjs/add/operator/multicast"), require("rxjs/Observable"), require("rxjs/Subject"), require("rxjs/add/operator/map"), require("rxjs/add/operator/filter"), require("rxjs/add/operator/catch"), require("rxjs/add/operator/first"), require("@angular/common"));
	else
		root["angularWeatherWidget"] = factory(root["ng"]["core"], root["ng"]["http"], root["Rx"], root["Rx"], root["Rx"], root["Rx"], root["Rx"], root["Rx"], root["Rx"], root["Rx"], root["Rx"], root["Rx"], root["ng"]["common"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_126__, __WEBPACK_EXTERNAL_MODULE_127__, __WEBPACK_EXTERNAL_MODULE_128__, __WEBPACK_EXTERNAL_MODULE_129__, __WEBPACK_EXTERNAL_MODULE_130__, __WEBPACK_EXTERNAL_MODULE_131__, __WEBPACK_EXTERNAL_MODULE_132__, __WEBPACK_EXTERNAL_MODULE_133__, __WEBPACK_EXTERNAL_MODULE_134__, __WEBPACK_EXTERNAL_MODULE_135__, __WEBPACK_EXTERNAL_MODULE_137__) {
...
})(ForecastMode = exports.ForecastMode || (exports.ForecastMode = {}));
...
})(WeatherLayout = exports.WeatherLayout || (exports.WeatherLayout = {}));
...
var Subject_1 = __webpack_require__(131);
    ...
    PoolingService.prototype.execute = function (operation, frequency) {
        ...
        var source = Observable_1.Observable.create(function (observer) {
            ...
            _this.zone.runOutsideAngular(function () {
                var zone = _this.zone;
                sub = Observable_1.Observable.interval(frequency).mergeMap(operation).subscribe({
...
var poling_service_1 = __webpack_require__(6);
var weather_container_1 = __webpack_require__(136);
var common_1 = __webpack_require__(137);
var weather_icon_component_1 = __webpack_require__(138);
var weather_current_description_component_1 = __webpack_require__(139);
var current_temperature_component_1 = __webpack_require__(7);
var actions_component_1 = __webpack_require__(140);
var weather_location_component_1 = __webpack_require__(141);
var weather_current_wind_component_1 = __webpack_require__(142);
var open_weather_map_api_service_1 = __webpack_require__(143);
var weather_current_details_component_1 = __webpack_require__(145);
var weather_forecast_component_1 = __webpack_require__(146);
var forecast_simple_grid_component_1 = __webpack_require__(147);
var weather_forecast_grid_day_component_1 = __webpack_require__(148);
var forecast_detailed_component_1 = __webpack_require__(149);
var forecast_detailed_day_component_1 = __webpack_require__(150);
var chart_component_1 = __webpack_require__(151);
var forecast_chart_wide_component_1 = __webpack_require__(201);
...
function apiServiceFactory(http, pooling, openWeather) {
    switch (openWeather.name) {
        case weather_api_service_1.WeatherApiName.OPEN_WEATHER_MAP:
            return new open_weather_map_api_service_1.OpenWeatherMapApiService(http, pooling, openWeather);
        default:
            return new open_weather_map_api_service_1.OpenWeatherMapApiService(http, pooling, openWeather);
    }
}
...
function forRoot(config) {
    return {
        ...
        providers: [
            poling_service_1.PoolingService,
            weather_helpers_service_1.WeatherHelpersService,
            {
...
exports.WeatherApiName = weather_api_service_2.WeatherApiName;
    ...
    WeatherCurrentWindComponent.prototype.mapScaleToText = function (scale) {
        switch (scale) {
            ...
            case current_temperature_component_1.TemperatureScale.KELVIN:
                return 'm/s';
            case current_temperature_component_1.TemperatureScale.FAHRENHEIT:
                return 'mil/h';
            default:
                return '';
        }
...
var poling_service_1 = __webpack_require__(6);
var weather_api_service_1 = __webpack_require__(4);
var open_weather_map_to_weather_icons_1 = __webpack_require__(144);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(1);
var chart_js_1 = __webpack_require__(152);
...
//# sourceMappingURL=angular-weather-widget.umd.js.map